...
int main(int argc, char **argv)
{
  ...
  gmsh::model::geo::addPoint(0, 0.1, .1, lc, 6);
  ...
  // gmsh::model::geo::addPoint(0.1, .1, 0, lc, 4);
  ...
  // for(int i = 0; i < 4; i++)
  //   gmsh::model::geo::addLine(i + 1, 5, i + 5);

  // gmsh::model::geo::addCurveLoop({1, 2, 3, 4}, 1);
  // gmsh::model::geo::addPlaneSurface({1}, 1);

  // gmsh::model::geo::addCurveLoop({-1, 5, -6}, 2);
  // gmsh::model::geo::addPlaneSurface({2}, 2);

  // gmsh::model::geo::addCurveLoop({-2, -7, 6}, 3);
  // gmsh::model::geo::addPlaneSurface({3}, 3);

  // gmsh::model::geo::addCurveLoop({-3, -8, 7}, 4);
  // gmsh::model::geo::addPlaneSurface({4}, 4);

  // gmsh::model::geo::addCurveLoop({-4, -5, 8}, 5);
  // gmsh::model::geo::addPlaneSurface({5}, 5);

  // gmsh::model::geo::addSurfaceLoop({1, 2, 3, 4, 5}, 1);
